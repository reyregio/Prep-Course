...
function arrayContiene(array, elemento) {
  ...
  //tmb fuciona >>>return array.includes(elemento)
}
...
function diaDeLaSemana(numeroDeDia) {
  //Suponga que los días de la semana se codifican como 1 = Domingo, 2 = Lunes y así 
  //sucesivamente. 
...
function empiezaConNueve(n) {
  //Desarrolle una función que recibe como parámetro un número 
  //entero n. Debe retornar true si el entero 
...
function todosIguales(arreglo) {
  ...
  //que indique si todos los elementos de un 
  //arreglo son iguales:
...
function mesesDelAño(array) {
  ...
  //meses del año desordenados, recorrer el array 
...
function breakStatement(numero) {
  ...
  //el numero recibido hasta un límite de
  // 10 veces.
  //Guardar cada nuevo valor en un array. 
  //Devolver el array
  //Si en algún momento el valor de la 
  //suma y la cantidad de iteraciones coinciden, 
...
function continueStatement(numero) {
  //Iterar en un bucle aumentando en 2 el 
  //numero recibido hasta un límite de 10 veces.
  //Guardar cada nuevo valor en un array.    
  //Devolver el array
  //Cuando el número de iteraciones alcance 
  //el valor 5, no se suma en ese caso y se continua 
