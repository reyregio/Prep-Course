...
function agregarPropiedad (objeto, property) {
  // Agrega una propiedad al 
  //objeto (argumento "objeto") 
  //con el valor `null`
  // Devuelve el objeto
  // NOTA: El nombre de la
  // propiedad no es "propiedad", 
  //el nombre es el valor del 
  //argumento llamado "property"
  // (una cadena/string)
  // Tu código:
...
function invocarMetodo (objeto, metodo) {
  // "metodo" es una cadena que 
  //contiene el nombre de un método 
  //(funcion) en el objeto
  // Invoca ese método
  // Nada necesita ser devuelto 
  //("returned")
  // Tu código:
  objeto[metodo]();
}
...
function agregarMetodoCalculoDescuento (producto) {
  ...
  //descuento
  // El método resta el 
  //descuento del precio y 
  //devuelve el precio con 
  //descuento
  // Devuelve el objeto 
